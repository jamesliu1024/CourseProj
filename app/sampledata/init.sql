...
('Admin1', '123456', 0, '1990-01-01', '2020-01-01'),
('Admin2', '123456', 1, '1992-02-14', '2021-02-15'),
('Admin3', '123456', 0, '1988-12-25', '2018-01-01'),
('Admin4', '123456', 1, '1995-05-20', '2022-05-21'),
('Admin5', '123456', 0, '1991-03-15', '2019-03-16'),
('Admin6', '123456', 1, '1994-06-30', '2020-07-01'),
('Admin7', '123456', 0, '1993-04-22', '2021-04-23'),
('Admin8', '123456', 1, '1996-09-10', '2023-09-11');
INSERT INTO admins (admin_name, admin_password, gender, birthday, start_time) VALUES
('Admin9', '123456', 0, '1997-08-08', '2022-08-09'),
('Admin10', '123456', 1, '1998-11-11', '2023-11-12');

#教师测试数据  教师id:1001-1009
INSERT INTO teachers (teacher_name, teacher_password, gender, birthday, start_time) VALUES
('张老师', '123456', 0, '1980-01-01', '2010-02-15'),
('李老师', '123456', 1, '1985-05-10', '2012-06-01'),
('王老师', '123456', 0, '1990-03-17', '2015-04-01'),
('赵老师', '123456', 1, '1978-12-25', '2008-01-01'),
('陈老师', '123456', 0, '1988-09-15', '2018-02-14'),
('刘老师', '123456', 1, '1992-06-30', '2020-07-01'),
('周老师', '123456', 0, '1983-11-11', '2013-10-15');
INSERT INTO teachers (teacher_name, teacher_password, gender, birthday, start_time) VALUES
('高老师', '123456', 1, '1986-02-28', '2016-03-15'),
('孙老师', '123456', 0, '1995-04-01', '2022-05-01');

#学生表测试数据  学生id:1001-1009
INSERT INTO students (student_name, student_password, gender, birthday, start_year, years) VALUES
('张三', '123456', 0, '2000-01-01', 2018, 4),
('李四', '123456', 1, '2001-05-10', 2019, 4),
('王五', '123456', 0, '2002-03-17', 2020, 4),
('赵六', '123456', 1, '1999-12-25', 2017, 5),
('陈七', '123456', 0, '2003-09-15', 2021, 2),
('刘八', '123456', 1, '2004-06-30', 2022, 4),
('周九', '123456', 0, '2005-11-11', 2023, 4);
INSERT INTO students (student_name, student_password, gender, birthday, start_year, years) VALUES
('吴十', '123456', 1, '2006-02-28', 2023, 4),
('郑十一', '123456', 0, '2007-04-01', 2024, 4);
